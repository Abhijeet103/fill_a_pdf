  ...
  return (
    <>
      <header className="site-header">
        ...
        <nav aria-label="Main navigation"><Link href="/#how-it-works">How it works</Link><Link href="/#privacy">Privacy</Link><Link href="/#faq">FAQ</Link></nav>
      ...
      <main className="policy-main">
        <article className="policy-card">
          ...
          <ul><li>PDF file contents or file bytes</li><li>PDF filenames</li><li>Form field names or values</li><li>Placed text</li><li>Copies of completed documents</li></ul>
          ...
          <p>Closing or refreshing the tab clears the active editing session. Your original PDF is not changed; the filled version is created only when you choose Download.</p>
          <h2>Questions</h2>
