...
export function SiteHeader() {
  return (
    <header className="site-header">
      <Link className="brand" href="/"><span className="brand-mark" aria-hidden="true">S</span><span>PDF Slate</span></Link>
...
export function SiteFooter() {
  return (
    <footer>
      <Link className="brand footer-brand" href="/"><span className="brand-mark" aria-hidden="true">S</span><span>PDF Slate</span></Link>
      ...
      <small>© {new Date().getFullYear()} PDF Slate. Your files stay yours.</small>
    </footer>
  );
}
